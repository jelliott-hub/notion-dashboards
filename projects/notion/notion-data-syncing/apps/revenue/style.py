"""Stripe-inspired styling for the analytics dashboard.

Replaces the B4ALL navy/blue theme with a cleaner, lighter palette
designed for Notion embeds. All helpers produce raw HTML strings or
Plotly layout dicts — no Streamlit widgets.
"""
